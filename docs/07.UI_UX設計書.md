...
- **Artifact風処理画面**: 左右分割レイアウト（左:リアルタイムログ、右:7フェーズプレビューブロック）
- **7フェーズHITL**: Phase1コンセプト・世界観分析、Phase2キャラクター設定等の各フェーズ完了時の30秒フィードバック待機システム
...
- **左パネル**: ヘッダー固定、ログエリア独立スクロール、フィードバック入力固定
...
<div class="hitl-layout">
  ...
  <div class="phase-sidebar">
    <div class="phase-timeline">
      <h2 class="timeline-title">生成進行状況</h2>
  ...
  <!-- 右メインエリア: プレビュー + フィードバック -->
  <div class="content-area">
    <div class="preview-section">
      <h2 class="preview-title">現在のフェーズ結果</h2>
    ...
    <div class="feedback-section" id="feedback-section" style="display: none;">
      <h3 class="feedback-title">修正したい点はありますか？</h3>
      <div class="feedback-options">
        <div class="quick-options">
          <button class="quick-btn" data-feedback="brighter">😊 明るく</button>
          <button class="quick-btn" data-feedback="serious">😐 シリアスに</button>
          <button class="quick-btn" data-feedback="detailed">🔍 詳細化</button>
          <button class="quick-btn" data-feedback="simple">✨ シンプルに</button>
        </div>
        <div class="natural-input">
          <textarea 
            class="feedback-input" 
            placeholder="例：「もっと若々しい雰囲気にして」「背景を学校に変更」"
            rows="3"></textarea>
          <div class="feedback-actions">
            <button class="btn-secondary" id="skip-feedback">スキップ</button>
            <button class="btn-primary" id="apply-feedback">修正を適用</button>
          </div>
        </div>
      </div>
    </div>
...
- 左サイドバーにフェーズタイムライン追加
- 右エリアにフィードバックインターフェース追加
- クイックオプション + 自然言語入力のデュアルフィードバック
- フィードバックタイムアウト（30分）機能
- フェーズ別プレビュー表示と修正結果反映
