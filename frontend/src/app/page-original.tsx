...
import { APITestButton } from '@/components/features/integration/APITestButton';
    ...
    <div className="min-h-screen bg-[rgb(var(--bg-primary))] flex flex-col animate-fade-in">
      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="max-w-3xl w-full space-y-8">
          ...
          {/* Development Integration Test - Remove in Production */}
          {process.env.NODE_ENV === 'development' && (
            <Card className="border-[rgb(var(--border-default))] bg-[rgb(var(--bg-tertiary))] opacity-75 animate-slide-up hover:shadow-lg hover:shadow-[rgb(var(--bg-accent))]/20 transition-shadow duration-300" style={{ animationDelay: '400ms' }}>
              <CardContent className="p-4">
                <h3 className="text-sm font-medium mb-2 text-[rgb(var(--text-secondary))]">開発者用: 統合テスト</h3>
                <APITestButton />
              </CardContent>
            </Card>
          )}
