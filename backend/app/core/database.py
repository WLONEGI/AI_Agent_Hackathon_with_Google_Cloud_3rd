...
async def get_database_session() -> AsyncGenerator[AsyncSession, None]:
    """Get database session for testing and integration purposes.
    
    This function provides backward compatibility for tests that need
    direct access to database sessions.
    """
    async with AsyncSessionLocal() as session:
        try:
            yield session
